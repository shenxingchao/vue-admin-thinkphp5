...
## 视频演示
链接：[点我查看演示视频](http://www.o8o8o8.com/vue/demo.html?_blank)
...
### 2.添加菜单路由配置
  ...
  svg图标则是从 [iconfont](http://www.iconfont.cn?_blank) 上下载下来的，保存到vuestage\src\icons\svg\文件夹下，自己命名即可，这里命名为admin.svg<br>
  如下图<br>
